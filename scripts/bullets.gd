...
const SPEED = 750
const bullet_image = preload("res://sprites//bullet.png")
...
func _ready():
	...
	for _i in BULLET_COUNT:
		...
		Physics2DServer.body_set_state(bullet.body, Physics2DServer.BODY_STATE_TRANSFORM, 
									   transform2d)
...
func _draw():
	for bullet in bullets:
		draw_texture(bullet_image, bullet.position)
